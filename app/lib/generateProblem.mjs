...
[1, 99999, 100000, 99995]	[9999, 9001, 9999, 9001]	3456789012	39354 처럼 변수와 그 값을 항상 표기해야 함. 반드시 임의의 인자 변수와 반환값 변수를 표기해야 함(반드시 알파벳). 변수는 항상 알파벳과 숫자로만 표기해야 하고 출력값 변수는 result로 고정.)
